...
const Sobre = () => {
  ...
  return (
    ...
    <div className="fonte w-[90%] h-[40%] flex-col gap-4 form-container">

      <div className=" container flex flex-box m-auto texto">
        <div className="justify-center flex w-[80%] h-[75%] mx-auto my-1"><Carrossel /></div>
      </div>

      <div className="w-[100%] h-[85%] shadow-md rounded-lg md-3 flex-col m-4 displayCounteiner-2 p-[2%] bg-[#121D13] mt-4 text-sm text-white text-justify">
        <p>
